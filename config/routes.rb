Rails.application.routes.draw do
  ...
  get '/restaurants/:slug/available_dates', to: 'restaurants#available_dates', as: 'restaurant_available_dates_api'
  get '/restaurants/:slug/available_times', to: 'restaurants#available_times', as: 'restaurant_available_times_api'
