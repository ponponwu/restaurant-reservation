module ComplexScenariosHelper
  ...
  def create_standard_restaurant_setup
    ...
    # 2人方桌 x 4
    tables[:square_2] = Array.new(4) do |i|
      create(:table,
    ...
    # 4人方桌 x 4
    tables[:square_4] = Array.new(4) do |i|
      create(:table,
             restaurant: restaurant,
             table_group: square_group,
             table_number: "S4-#{i + 1}",
    ...
    # 6人圓桌 x 3
    tables[:round_6] = Array.new(3) do |i|
      create(:table,
             restaurant: restaurant,
    ...
    # 窗邊圓桌 x 2（8人桌，可併桌）
    tables[:window_8] = Array.new(2) do |i|
      create(:table,
             restaurant: restaurant,
    ...
    # 吧台座位 x 6（1-2人）
    tables[:bar_seats] = Array.new(6) do |i|
      create(:table,
             restaurant: restaurant,
  ...
  def create_special_needs_scenarios(restaurant, reservation_period, base_time)
    ...
    scenarios << {
      ...
      requirements: %i[child_friendly no_bar_tables high_chair]
    }
    ...
    scenarios << {
      ...
      requirements: %i[wheelchair_accessible ground_floor wide_space]
    }
    ...
    scenarios << {
      ...
      requirements: %i[quiet_area round_table_preferred good_lighting]
    }
